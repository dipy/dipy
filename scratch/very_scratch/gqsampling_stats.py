...
def test_gqiodf():
    ...
    assert_true(
        meshes.euler_characteristic_check(odf_vertices, odf_faces, chi=2),
    ...
    assert_array_equal(
        (len(peaks_1), len(peaks_2), len(peaks_3)), (790, 196, 14),
    ...
    # print 'pole_3 equator contains:',
    # len(meshes'equatorial_vertices(vertices,pole_3,width))
...
def triple_odf_maxima(vertices, odf, width):
    ...
    odfmax1 = odf[indmax1]
    indmax2, odfmax2 = equatorial_maximum(
        vertices, odf, vertices[indmax1], width)
