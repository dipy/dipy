...
def test_estimate_sigma():
    ...
    assert_array_almost_equal(sigma, 0.10286889997472792 / np.sqrt(0.4292036732
                                                                   0510366))
    ...
    assert_array_almost_equal(sigma,
                              np.array([0.10286889997472792 / np.sqrt(0.4292036
                                                                      732051036
                                                                      6),
                                        0.10286889997472792 / np.sqrt(0.4292036
                                                                      732051036
                                                                      6),
                                        0.10286889997472792 / np.sqrt(0.4292036
                                                                      732051036
