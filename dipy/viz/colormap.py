...
def distinguishable_colormap(bg=(0, 0, 0), exclude=[], n_colors=30):
    ...
    n_colors : int (optional)
        Expected number of desired colors. If you don't precisely know how
        many you will need in advance, there is no harm (other than execution
        time) in specifying slightly more than you think you will need.
        Default: 27k colors.

    Returns
    -------
    iterator of tuple
        Next RBG color maximally perceptually distinct from previous ones.
