...
def plot_2d_diffeomorphic_map(mapping, delta=10, fname=None,
                              direct_grid_shape=None, direct_grid2space=-1,
                              inverse_grid_shape=None, inverse_grid2space=-1,
                              show_figure=True):
    ...
    direct_grid2space : array, shape (3, 3), optional
        ...
        they should also specify direct_grid2space).
    inverse_grid_shape : tuple, shape (2,), optional
        ...
        the moving).
    inverse_grid2space : array, shape (3, 3), optional
        ...
        they should also specify inverse_grid2space).
    ...
    warped_forward = mapping.transform(lattice_out, 'linear', world_to_image,
                                       direct_grid_shape, direct_grid2space)

    # Now, the world-to-image (image = drawn lattice on the input grid)
    # transformation is the inverse of the input affine
    world_to_image = None
    if direct_grid2space is not None:
        world_to_image = np.linalg.inv(direct_grid2space)
