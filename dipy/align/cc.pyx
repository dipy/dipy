...
def precompute_cc_factors_3d(floating[:, :, :] fixed, floating[:, :, :] moving,
                             int radius):
...
def compute_cc_forward_step_3d(floating[:, :, :, :] gradFixed,
                               floating[:, :, :, :] gradMoving,
                               floating[:, :, :, :] factors):
...
def compute_cc_backward_step_3d(floating[:, :, :, :] gradFixed,
                                floating[:, :, :, :] gradMoving,
                                floating[:, :, :, :] factors):
    cdef int ns = gradFixed.shape[0]
    cdef int nr = gradFixed.shape[1]
