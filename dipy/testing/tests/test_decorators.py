...
def test_warning_for_keywords():
    ...
    @warning_for_keywords(from_version="1.0.0", until_version="2.0.0")
    ...
    with warnings.catch_warnings(record=True) as w:
        ...
        assert (
            "Pass ['c'] as keyword args. From version 2.0.0 passing these as "
    ...
    # Case 4: Version is 2.0.0, arguments should pass as they are,
    # expecting TypeError from system
    dipy.__version__ = "2.0.0"
    try:
        result = func_with_kwonly_args(1, 2, 3)
    except TypeError:
        print("Expected TypeError for version 2.0.0")
