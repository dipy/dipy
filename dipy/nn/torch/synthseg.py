    ...
    def predict(
        ...
        *,
        ...
        return_masks : bool, optional
            Whether to return brain masks with the predicted labels. The masks
            are generated from the non-background labels after applying
            ``remove_holes_and_islands``. As a result, they can include voxels
            labeled as background and are not strictly the union of the label
            maps. Ignored if ``return_prob`` is True.
        ...
        masks : np.ndarray (...) or (batch, ...)
            ...
            Only if return_prob is False and return_masks is True.
        """
        ...
        if return_masks and not return_prob:
            warnings.warn(
