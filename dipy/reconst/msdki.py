...
from dipy.core.gradients import (check_multi_b, unique_bvals_mag, round_bvals)
...
def mean_signal_bvalue(data, gtab, bmag=None):
    ...
    ub, rb = unique_bvals_mag(bvals, bmag=bmag, rbvals=True)
...
class MeanDiffusionKurtosisModel(ReconstModel):
    ...
    def __init__(self, gtab, bmag=None, return_S0_hat=False, *args, **kwargs):
        ...
        self.ubvals = unique_bvals_mag(gtab.bvals, bmag=bmag)
