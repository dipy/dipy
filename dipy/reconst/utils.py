...
def compute_fiber_coherence(
    ...
    *,
    ...
    for offset in neighbor_offsets:
        # d̂: unit displacement vector from center voxel to neighbor voxel
        ...
        # Check if each fiber aligns with the displacement direction d̂
        # Paper formula: I(|<d̂, û>| > cos(30°)) × I(|<d̂, v̂>| > cos(30°))
