...
def cti_design_matrix(gtab1, gtab2):
    ...
    B[:, 9] = b1*n1[:, 1]**2 * b2*n2[:, 2]**2 + b1*n1[:, 2]**2 * b2*n2[:, 1]**2
    B[:, 10] = b1*n1[:, 0]**2 * b2*n2[:, 2]**2 + b1*n1[:, 2]**2 * b2*n2[:, 0]**2
    B[:, 11] = b1*n1[:, 0]**2 * b2*n2[:, 1]**2 + b1*n1[:, 1]**2 * b2*n2[:, 0]**2
    B[:, 12] = 2 * (b1*n1[:, 0]**2 * b2*n2[:, 1]*n2[:, 2] +
                    b1*n1[:, 1]*n1[:, 2] * b2*n2[:, 0]**2)
    B[:, 13] = 2 * (b1*n1[:, 0]**2 * b2*n2[:, 0] * n2[:, 2] +
                    b1*n1[:, 0]*n1[:, 2] * b2*n2[:, 0]**2)
    B[:, 14] = 2 * (b1*n1[:, 0]**2 * b2*n2[:, 0] * n2[:, 1] +
                    b1*n1[:, 0]*n1[:, 1] * b2*n2[:, 0]**2)
    B[:, 15] = 2 * (b1*n1[:, 1]**2 * b2*n2[:, 1] * n2[:, 2] +
                    b1*n1[:, 1]*n1[:, 2] * b2*n2[:, 1]**2)
    B[:, 16] = 2 * (b1*n1[:, 1]**2 * b2*n2[:, 0]*n2[:, 2] +
                    b1*n1[:, 0]*n1[:, 2] * b2*n2[:, 1]**2)
    B[:, 17] = 2 * (b1*n1[:, 1]**2 * b2*n2[:, 1] * n2[:, 0] +
                    b1*n1[:, 1]*n1[:, 0] * b2*n2[:, 1]**2)
    B[:, 18] = 2 * (b1*n1[:, 2]**2 * b2*n2[:, 2] * n2[:, 1] +
                    b1*n1[:, 2]*n1[:, 1] * b2*n2[:, 2]**2)
    B[:, 19] = 2 * (b1*n1[:, 2]**2 * b2*n2[:, 2] * n2[:, 0] +
                    b1*n1[:, 2]*n1[:, 0] * b2*n2[:, 2]**2)
    B[:, 20] = 2 * (b1*n1[:, 2]**2 * b2*n2[:, 0]*n2[:, 1] +
                    b1*n1[:, 0]*n1[:, 1] * b2*n2[:, 2]**2)
    B[:, 21] = 4 * (b1*n1[:, 1] * n1[:, 2] * b2*n2[:, 1] * n2[:, 2])
    B[:, 22] = 4 * (b1*n1[:, 0] * n1[:, 2] * b2*n2[:, 0] * n2[:, 2])
    B[:, 23] = 4 * (b1*n1[:, 0] * n1[:, 1] * b2*n2[:, 0] * n2[:, 1])
    B[:, 24] = 4 * (b1*n1[:, 0] * n1[:, 2] * b2*n2[:, 1] *
                    n2[:, 2] + b1*n1[:, 1]*n1[:, 2] * b2*n2[:, 0]*n2[:, 2])
    B[:, 25] = 4 * (b1*n1[:, 0] * n1[:, 1] * b2*n2[:, 0] *
                    n2[:, 2] + b1*n1[:, 0]*n1[:, 2] * b2*n2[:, 0]*n2[:, 1])
    B[:, 26] = 4 * (b1*n1[:, 0] * n1[:, 1] * b2*n2[:, 1] *
