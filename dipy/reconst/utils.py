...
def cti_design_matrix(gtab1, gtab2):
    ...
    B[:, 18] = 2 * b1 * b1 * n1[:, 0] ** 2*n1[:, 1] * \
        n1[:, 2] + 2*b2*b2*n2[:, 0]**2*n2[:, 1]*n2[:, 2]
    B[:, 19] = 2 * b1 * b1 * n1[:, 1] ** 2*n1[:, 0] * \
        n1[:, 2] + 2*b2*b2*n2[:, 1]**2*n2[:, 0]*n2[:, 2]
    B[:, 20] = 2 * b1 * b1 * n1[:, 2] ** 2*n1[:, 0] * \
        n1[:, 1] + 2*b2*b2*n2[:, 2]**2*n2[:, 0]*n2[:, 1]
    B[:, 21] = b1 * n1[:, 0]**2 * b2 * n2[:, 0]**2
    B[:, 22] = b1 * n1[:, 1]**2 * b2 * n2[:, 1]**2
    B[:, 23] = b1 * n1[:, 2]**2 * b2 * n2[:, 2]**2
    B[:, 24] = b1*n1[:, 1]**2 * b2*n2[:, 2]**2 + b1*n1[:, 2]**2 * b2*n2[:, 1]**2
    B[:, 25] = b1*n1[:, 0]**2 * b2*n2[:, 2]**2 + b1*n1[:, 2]**2 * b2*n2[:, 0]**2
    B[:, 26] = b1*n1[:, 0]**2 * b2*n2[:, 1]**2 + b1*n1[:, 1]**2 * b2*n2[:, 0]**2
    ...
    B[:, 39] = 4 * (b1*n1[:, 0] * n1[:, 2] * b2*n2[:, 1] *
                    n2[:, 2] + b1*n1[:, 1]*n1[:, 2] * b2*n2[:, 0]*n2[:, 2])
    B[:, 40] = 4 * (b1*n1[:, 0] * n1[:, 1] * b2*n2[:, 0] *
