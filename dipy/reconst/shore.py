        ...
        if not self.constrain_e0:
            ...
            if not(self.positive_constraint):
                ...
                if G is None:
                    ...
                    self.cache_set(
                        'shore_matrix_positive_constraint',
                        (self.pos_grid, self.pos_radius), G)
...
def shore_indices(radial_order, index):
    ...
    if n_c < (index + 1):
        msg = "The index is higher than the number of coefficients \
