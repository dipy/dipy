...
def generate_gtab4D(number_of_tau_shells=4):
    ...
    gtab_4d = gradient_table(qvals=qvals, bvecs=bvecs, pulse_separation=pulse_separation, pulse_duration=pulse_duration)
    return gtab_4d
...
def test_anisotropic_isotropic_equivalence_tau(radial_order=4, time_order=2):
...
def test_anisotropic_isotropic_equivalence_tau_inf(radial_order=4, time_order=2):
    gtab_4d = generate_gtab4D()
...
def test_anisotropic_isotropic_equivalence_both_tau_and_tau_inf(radial_order=4,
                                                                time_order=2):
    gtab_4d = generate_gtab4D()
...
def test_anisotropic_normalization(radial_order=4, time_order=2):
    ...
    mapmod_aniso = maptime.MaptimeModel(gtab_4d, radial_order=radial_order,
                                        ...
                                        fit_tau=True,
                                        fit_tau_inf=True)
    mapmod_aniso_norm = maptime.MaptimeModel(gtab_4d, radial_order=radial_order,
                                             time_order=time_order,
                                             cartesian=False,
                                             anisotropic_scaling=False,
                                             fit_tau=True,
...
#def test_maptime_positivity_constraint(radial_order=6, time_order=3):
#    S_noise = add_noise(signal, 30, 1.)
#    
#    mapmod_no_constraint = maptime.MaptimeModel(gtab_4d,
...
#    
#    mapmod_constraint = maptime.MaptimeModel(gtab_4d,
#                                        radial_order=radial_order,
#                                        time_order=time_order,
#                                        laplacian_regularization=False,
#                                        positivity_constraint=True)
#    mapmod_constraint.constraint_grid = r_grad
