...
def test_shore_metrics():
    ...
    # since we are testing without noise we can use higher order
    # and lower lambdas, with respect to the default.
    radial_order = 8
    zeta = 700
    lambdaN = 1e-12
    lambdaL = 1e-12
    ...
    # test if the integral of the pdf calculated on a discrete
