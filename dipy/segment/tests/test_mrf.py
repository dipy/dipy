...
def test_grayscale_image():
    ...
    npt.assert_allclose(mu, np.array([0.0, 0.25, 0.5, 0.75]))
    npt.assert_allclose(sigmasq, np.array([1.0, 1.0, 1.0, 1.0]))
    ...
    if beta == 0.0:
        npt.assert_allclose(PLN[50, 50, 1, 0], 0.25, True)
        npt.assert_allclose(PLN[50, 50, 1, 1], 0.25, True)
        npt.assert_allclose(PLN[50, 50, 1, 2], 0.25, True)
        npt.assert_allclose(PLN[50, 50, 1, 3], 0.25, True)
        npt.assert_allclose(PLN[147, 129, 1, 0], 0.25, True)
        npt.assert_allclose(PLN[147, 129, 1, 1], 0.25, True)
        npt.assert_allclose(PLN[147, 129, 1, 2], 0.25, True)
        npt.assert_allclose(PLN[147, 129, 1, 3], 0.25, True)
        npt.assert_allclose(PLN[61, 152, 1, 0], 0.25, True)
        npt.assert_allclose(PLN[61, 152, 1, 1], 0.25, True)
        npt.assert_allclose(PLN[61, 152, 1, 2], 0.25, True)
        npt.assert_allclose(PLN[61, 152, 1, 3], 0.25, True)
        npt.assert_allclose(PLN[100, 100, 1, 0], 0.25, True)
        npt.assert_allclose(PLN[100, 100, 1, 1], 0.25, True)
        npt.assert_allclose(PLN[100, 100, 1, 2], 0.25, True)
        npt.assert_allclose(PLN[100, 100, 1, 3], 0.25, True)
