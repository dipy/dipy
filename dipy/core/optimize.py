...
def sparse_sgd(y, X,
    ...
    X: ndarray or sparse array or pytables file
        The regressors shape (N, M). If pytables file needs to contain the
        information needed to generate a sparse CSR array:
           X.root. X.root.col, X
