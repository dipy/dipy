...
def genStreamlinesMergeProb_generator(DIMX, DIMY, DIMZ, DIMT, SPHERE_SYMM, STEP_SIZE, MAX_ANGLE, TC_THRESHOLD, MAX_SLINE_LEN, PMF_THRESHOLD_P):
    ...
    def get_direction_prob_step(
        ...
        new_dir,         # float64[3]  output: chosen next direction (written in-place)
