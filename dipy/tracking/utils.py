...
def random_seeds_from_mask(mask, seeds_per_voxel=1, affine=None):
    ...
    array([[ 0.17096845,  0.49764053,  0.16602047],
       [-0.24738643,  0.37363354,  0.29839542],
       [-0.4917629 ,  0.06639896,  0.20391461],
       [-0.36902859, -0.21677413, -0.38789741],
       [ 0.20036731,  0.21701647, -0.37853069],
       [-0.3967652 , -0.48971098, -0.35693683]])
    >>> mask[0,1,2] = 1
    >>> random_seeds_from_mask(mask, seeds_per_voxel=2)
    array([[-0.16674708,  0.37328403,  0.33578302],
       [ 0.43265268,  0.41722042,  0.17353814],
       [-0.0930469 ,  1.11465374,  2.08878117],
       [ 0.27144816,  1.13170702,  2.30005706]])
