...
You've discovered a bug or something else you want to change in dipy_ - excellent!
...
Then, send the generated patch files to the `dipy mailing list`_ - where we will thank you warmly.
...
#. If you don't already have one, clone a copy of the dipy_ repository::
...
Fork the dipy_ repository on github_ - :ref:`forking`.  Then::
   ...
   git remote add origin git@github.com:your-user-name/dipy.git
