...
specifics for the dipy_ project, and to suggest some default names.
...
#. Go to the dipy_ github home at `dipy github`_.
#. Click on the *fork* button:

   .. image:: forking_button.png

   Now, after a short pause and some 'Hardcore forking action', you
   should find yourself at the home page for your own forked copy of dipy_.
