...
# streamline. This is that when we later extract values from a volume, we won't
# have different streamlines going in opposite directions.
#
...
# for different subjects, which means that we'll get roughly the same
# orientation
