...
This example shows how to use parallelism (multiprocessing) in order to speedup
the signal reconstruction process. For this example will we use the same steps
