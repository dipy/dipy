...
sh_coeffs = sf_to_sh(odf, sphere, sh_degree_max, sh_basis)
...
reconst = sh_to_sf(sh_coeffs, high_res_sph, sh_degree_max, sh_basis)
...
sh_coeffs = sf_to_sh(asym_odf, sphere, sh_degree_max, sh_basis)
reconst = sh_to_sf(sh_coeffs, high_res_sph, sh_degree_max, sh_basis)
...
sh_coeffs = sf_to_sh(asym_odf, sphere, sh_degree_max,
                     sh_basis, full_basis=True)
reconst = sh_to_sf(sh_coeffs, high_res_sph, sh_degree_max,
                   sh_basis, full_basis=True)
