...
rtop_signal=dsmodel.fit(dataslice).rtop_signal(normalized=False)
...
ax2.set_title('rtop_signal')
ind=ax2.imshow(rtop_signal.T,interpolation='nearest',origin='lower')
plt.colorbar(ind)
