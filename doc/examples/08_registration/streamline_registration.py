...
b0_masked_stanford, _ = median_otsu(
    b0_data_stanford,
    vol_idx=list(range(b0_data_stanford.shape[-1])), median_radius=4, numpass=4)
...
#
# We will first perform an affine registration to roughly align the
# two volumes:
...
#    Evaluating Automated Labeling of Elderly and Neurodegenerative Brain, 12
#    (1), 26-41.
#
