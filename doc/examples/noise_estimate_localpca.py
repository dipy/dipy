...
ax[0,0].imshow(data[:,:,30,13], cmap='gray', origin='lower')
ax[0,0].set_title('Original')
ax[0,1].imshow(sigma[:,:,30], cmap='gray', origin='lower')
ax[0,1].set_title('sigma by PCA')
ax[0,2].imshow(sigma_corr[:,:,30,13], cmap='gray', origin='lower')
ax[0,2].set_title('after rescaling')
ax[1,0].imshow(sigmar[:,:,30], cmap='gray', origin='lower')
ax[1,0].set_title('sigma by PCA + LPF')
ax[1,1].imshow(sigma_corrr[:,:,30,13], cmap='gray', origin='lower')
ax[1,1].set_title('after rescaling + LPF')
ax[1,2].imshow(I[:,:,30], cmap='gray', origin= 'lower')
