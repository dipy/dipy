...
# labeled either 1 or 2. Lets create a white matter mask to restrict tracking
# to the white matter.
...
# from this region will give us a model of the corpus callosum tract. This slice
# has label value ``2`` in the labels image.
