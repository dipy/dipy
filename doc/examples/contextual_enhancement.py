...
spike[3, 3, 3, 0] = 1
spike_shm_conv = convolve(sf_to_sh(spike, k.get_sphere(), sh_degree_max=8), k,
                          sh_degree_max=8, test_mode=True)

spike_sf_conv = sh_to_sf(spike_shm_conv, default_sphere, sh_degree_max=8)
...
# Perform convolution
csd_shm_enh = convolve(csd_shm_noisy, k, sh_degree_max=8)
...
csd_sf_orig = sh_to_sf(csd_shm_orig, default_sphere, sh_degree_max=8)
csd_sf_noisy = sh_to_sf(csd_shm_noisy, default_sphere, sh_degree_max=8)
csd_sf_enh = sh_to_sf(csd_shm_enh, default_sphere, sh_degree_max=8)
csd_sf_enh_sharp = sh_to_sf(csd_shm_enh_sharp, default_sphere, sh_degree_max=8)
