...
"""
Let's visualize static bundle in red and moved (warped) in green.
"""

viz_bundles(static, deformed_bundle,
            fname="output/static_and_partially_deformed.png")
...
viz_bundles(moving_aligned, deformed_bundle,
            fname="output/linearly_and_nonlinearly_moved.png", c1=(0, 0, 1))
...
viz_bundles(static, deformed_bundle2,
            fname="output/static_and_fully_deformed.png")
