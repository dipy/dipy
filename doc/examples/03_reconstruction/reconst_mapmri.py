...
#   is smaller, meaning more overall restriction. This is illustrated by the low
...
#   the probability that a proton will be on the plane perpendicular to the main
