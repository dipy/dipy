...
# ``auto_response``. For, this purpose we can print it and have a look at its
# values.
...
# the sphere), as a set of putative fascicle directions that are considered in
# the model
