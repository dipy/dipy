...
description: "File a performance report to improve DIPY's performance"
...
body:
  ...
  - type: textarea
    attributes:
      label: Summary
      description: |
        A clear and concise description of the proposed implementation change, including a minimal reproducible example.

        Please, explain what your reasonable performance expectations are.
    validations:
      required: true
  ...
  - type: textarea
    attributes:
      ...
      description: |
        Analysis of the impact of the current implementation in terms of performance, and how another implementation
        would benefit the performance of the toolkit, including the benefits/downsides of both approaches infrastructure.
    validations:
      required: false
